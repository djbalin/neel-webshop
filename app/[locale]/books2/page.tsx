  ...
  return (
    <>
      ...
      <section className="place-items-center pt-12 space-y-4 w-3/4 mx-auto pb-32">
        ...
        <p>Facet 5 er or dig, som nart skal op til sadkaimiamta</p>
        ...
        <div className="grid gap-x-8 gap-y-8 grid-cols-2">
          ...
          <div>
            ...
            <p className="paragraph">
              ...
              passiv, modalverber, frasalverber, forbinderord og ordstilling,
              sammensatte substantiver, præpositionsforbindelser og adjektiver.
            </p>
          </div>
          <div>
            ...
            <p className="paragraph">
              ...
              hører dansk som det tales blandt venner, studerende og kollegaer,
              dansk i tiden.
            </p>
